...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "a_param" -parent ${Page_0}
...
proc update_PARAM_VALUE.a_param { PARAM_VALUE.a_param } {
	# Procedure called to update a_param when any of the dependent parameters in the arguments change
}
...
proc update_MODELPARAM_VALUE.a_param { MODELPARAM_VALUE.a_param PARAM_VALUE.a_param } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.a_param}] ${MODELPARAM_VALUE.a_param}
}
