...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "cell20" -parent ${Page_0}
  ipgui::add_param $IPINST -name "cell21" -parent ${Page_0}
  ipgui::add_param $IPINST -name "cell22" -parent ${Page_0}
  ipgui::add_param $IPINST -name "cell23" -parent ${Page_0}
...
proc update_PARAM_VALUE.cell20 { PARAM_VALUE.cell20 } {
	# Procedure called to update cell20 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.cell20 { PARAM_VALUE.cell20 } {
	# Procedure called to validate cell20
	return true
}

proc update_PARAM_VALUE.cell21 { PARAM_VALUE.cell21 } {
	# Procedure called to update cell21 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.cell21 { PARAM_VALUE.cell21 } {
	# Procedure called to validate cell21
	return true
}

proc update_PARAM_VALUE.cell22 { PARAM_VALUE.cell22 } {
	# Procedure called to update cell22 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.cell22 { PARAM_VALUE.cell22 } {
	# Procedure called to validate cell22
	return true
}

proc update_PARAM_VALUE.cell23 { PARAM_VALUE.cell23 } {
	# Procedure called to update cell23 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.cell23 { PARAM_VALUE.cell23 } {
	# Procedure called to validate cell23
	return true
}
...
proc update_MODELPARAM_VALUE.cell20 { MODELPARAM_VALUE.cell20 PARAM_VALUE.cell20 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.cell20}] ${MODELPARAM_VALUE.cell20}
}

proc update_MODELPARAM_VALUE.cell21 { MODELPARAM_VALUE.cell21 PARAM_VALUE.cell21 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.cell21}] ${MODELPARAM_VALUE.cell21}
}

proc update_MODELPARAM_VALUE.cell22 { MODELPARAM_VALUE.cell22 PARAM_VALUE.cell22 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.cell22}] ${MODELPARAM_VALUE.cell22}
}

proc update_MODELPARAM_VALUE.cell23 { MODELPARAM_VALUE.cell23 PARAM_VALUE.cell23 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.cell23}] ${MODELPARAM_VALUE.cell23}
}
